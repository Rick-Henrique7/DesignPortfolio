...
export default function Hero() {
  return (
    ...
    <div className="grid grid-cols-1 mb-4 gap-6">
        <div className="bg-card-bg rounded-2xl p-4 sm:p-6 md:p-8 flex items-center justify-start min-h-[80px] sm:min-h-[100px]">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-text-primary">Amanda <strong>Abreu</strong></h1>
          </div>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 grid grid-rows-2 gap-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-[500px_1fr] gap-4 sm:gap-6">
            ...
            <div className="bg-card-bg rounded-2xl p-4 sm:p-6 md:p-8 flex items-center justify-center min-h-[180px] sm:min-h-[200px] md:min-h-[220px]">
              <h2 className="text-xl sm:text-2xl md:text-3xl italic text-text-primary text-center">Inovação que inspira</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-card-bg rounded-2xl p-0 overflow-hidden h-full">
            <div className="w-full h-64 sm:h-72 md:h-full bg-card-bg rounded-2xl flex items-center justify-center">
              <h3 className="text-xl sm:text-2xl font-extrabold tracking-tight text-text-primary">Destaque</h3>
            </div>
          </div>
